...
ابزارPyDataAnalyzer از خط فرمان اجرا می‌شود. نحو پایه به شرح زیر است:
...
ابزارPyDataAnalyzer از آرگومان‌های خط فرمان زیر پشتیبانی می‌کند:
...
در اینجا چندین دستور مثال ارائه شده که قابلیت‌های PyDataAnalyzer را نشان می‌دهد:
...
ابزارPyDataAnalyzer چندین فایل خروجی تولید می‌کند:
...
مشارکت در PyDataAnalyzer مورد استقبال قرار می‌گیرد! نحوه مشارکت به شرح زیر است:
...
با تشکر از استفاده شما از PyDataAnalyzer!
